...
5. `TaskItem()` - 3 edges
6. `App()` - 2 edges
7. `CalendarGrid()` - 2 edges
8. `MonthGrid()` - 2 edges
9. `EventCard()` - 2 edges
10. `EventDetail()` - 2 edges
...
## Knowledge Gaps
- **35 isolated node(s):** `General Guidelines`, `name`, `private`, `version`, `type` (+30 more)
...
- **What connects `General Guidelines`, `name`, `private` to the rest of the system?**
